...
class FloatingHandwritingKeyboard(QWidget):
    ...
    def init_ui(self):
        ...
        self.auto_type_cb.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.bksp_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
    ...
    def toggle_language(self):
        if self.current_lang == "hi":
            ...
            self.lang_btn.setStyleSheet("background: #10b981; color: white; font-weight: 600; border-radius: 6px; border: none; font-size: 11px;")
        else:
            self.current_lang = "hi"
        ...
        for word in candidates[:6]:
            ...
            chip.setStyleSheet("""
                QPushButton {
                    ...
                    border-radius: 11px; padding: 2px 9px; font-weight: 600; font-size: 11px;
                }
